...
unique_companies = pd.read_json('./uniqueCompaniesWithQidsAndWithOurIndustrySectors.json')
...
# Select columns
merged_items = merged_items[['rank', 'company', 'market_cap', 'year', 'headquarterCoordinates', 'qid', 'wikiDataName']]

merged_items.to_json('./sp500RankingWithCoordinates.json', orient='records', indent=4)
