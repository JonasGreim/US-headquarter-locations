...
left_join(data_1990, df_49)
left_join(data_1994, df_49)
left_join(data_1999, df_49)
left_join(data_2004, df_49)
left_join(data_2009, df_49)
left_join(data_2014, df_49)
left_join(data_2019, df_49)
left_join(data_2024, df_49)
